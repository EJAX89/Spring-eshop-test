	...
	<div class="container 75%">
		<div class="row 200%">
			<div class="6u 12u$(medium)">
				<header class="major"> 
				<h1> Průběh Vaší objednávky byl přerušen.</h1>
			</div>
			<div class="6u 12u$(medium)">
			<p>Můžete pokračovat v nákupu.</p>
			<p><a href="<spring:url value="/products" />" class="button special small"> Zpět na produkty.</a>

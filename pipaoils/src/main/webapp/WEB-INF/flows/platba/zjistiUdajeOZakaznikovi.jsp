				...
				<header class="major"> <form:form
					...
					<fieldset>
						...
						<div class="form-group">
							...
							<div class="col-lg-10">
								<form:input id="ulice" path="adresa.ulice."
									type="text" class="form:input-large" />
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-lg-2" for="cisloPopisne">Číslo popisné</label>
							<div class="col-lg-10">
								<form:input id="cisloPopisne" path="adresa.cisloPopisne" type="text"
									class="form:input-large" />
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-lg-10">
								<form:input id="mesto" path="adresa.mesto"
									type="text" class="form:input-large" />
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-lg-10">
								<form:input id="psc" path="adresa.psc" type="text"
									class="form:input-large" />
							</div>
						</div>
						...
						<div class="form-group">
							<label class="control-label col-lg-2" for="telCislo">Telefonní číslo</label>
							<div class="col-lg-10">
								<form:input id="telCislo" path="telCislo" type="text"
									class="form:input-large" />
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<div class="col-lg-offset-2 col-lg-10">
								<input type="submit" id="btnAdd" class="btn btn-primary"
									value="Pokračuj" name="_eventId_udajeZjisteny" />
								<button id="btnCancel" class="button special small"
									name="_eventId_cancel">Zrušit</button>
							</div>
						</div>
				</form:form>
			</div>

...
<jsp:include page="header.jsp" />
 <script type="text/javascript" src="/pipaoils/resources/tiny_mce/tiny_mce.js"></script>
		...
		<form:form commandName="product" id="edit-product-form" method="post" class="form-horizontal"  enctype="multipart/form-data" action="${pageContext.request.contextPath}/admin/update">	
			<fieldset>
				...
				<div class="form-group">
					<label class="control-label col-lg-2" for="popisDlouhy">Dlouhý popis</label>
					<div class="col-lg-10">
